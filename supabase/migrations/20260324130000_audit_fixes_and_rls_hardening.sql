-- Hardening of tenant isolation functions to ensure correct RLS checks
-- Replaces pure string comparisons with robust JWT metadata checks
-- Includes implicit protection against payload injection
...
-- Update the get_tenant_users RPC to be more robust and rely strictly on hardened RLS function
...
-- Update get_all_users to ensure it's strictly executed by super admins only
