    ...
    Tables: {
      ...
      osc_bank_statement_lines: {
        Row: {
          ...
          restitution_line_id: string | null
      ...
      tenants: {
        Row: {
          acting_areas: Json | null
          cnpj: string | null
          context_data: Json | null
          created_at: string
          digital_profile: Json | null
          id: string
          labor_profile: Json | null
          name: string
          org_subtype: string | null
          org_type: string | null
          public_relations: string | null
          status: string | null
          step_1: Json | null
          step_2: Json | null
          step_3: Json | null
...
//   description: text (nullable)
//   affected_data: text (nullable)
//   created_at: timestamp with time zone (not null, default: now())
// Table: digital_requests
//   id: uuid (not null, default: gen_random_uuid())
//   tenant_id: uuid (not null)
...
//   data_categories: text (nullable)
//   data_subjects: text (nullable)
//   legal_basis: text (nullable)
//   retention_time: text (nullable)
...
//   created_at: timestamp with time zone (not null, default: now())
//   updated_at: timestamp with time zone (not null, default: now())
//   block_payments: boolean (nullable, default: false)
//   last_incident_date: date (nullable)
...
// Table: osc_accountability_diligences
//   id: uuid (not null, default: gen_random_uuid())
...
//   created_at: timestamp with time zone (not null, default: now())
//   glosa_amount: numeric (nullable, default: 0)
//   glosa_reason: text (nullable)
// Table: osc_bank_accounts
//   id: uuid (not null, default: gen_random_uuid())
//   partnership_id: uuid (not null)
//   name: text (not null)
...
//   created_at: timestamp with time zone (not null, default: now())
// Table: osc_bank_statement_lines
//   id: uuid (not null, default: gen_random_uuid())
//   partnership_id: uuid (not null)
...
//   classification: text (nullable)
//   status: text (nullable, default: 'Importada'::text)
//   category_code: text (nullable)
//   provider_name: text (nullable)
//   provider_document: text (nullable)
//   invoice_number: text (nullable)
//   invoice_date: date (nullable)
//   document_url: text (nullable)
//   restitution_line_id: uuid (nullable)
//   restitution_status: text (nullable)
//   competence_month: text (nullable)
//   created_at: timestamp with time zone (not null, default: now())
//   updated_at: timestamp with time zone (not null, default: now())
//   gross_value: numeric (nullable)
// Table: osc_financial_incomes
//   id: uuid (not null, default: gen_random_uuid())
//   partnership_id: uuid (not null)
...
//   created_at: timestamp with time zone (not null, default: now())
// Table: osc_financial_transactions
//   id: uuid (not null, default: gen_random_uuid())
//   partnership_id: uuid (not null)
...
//   nexus_notes: text (nullable)
//   status: text (nullable, default: 'Pendente'::text)
//   created_at: timestamp with time zone (not null, default: now())
// Table: osc_inclusive_cases
//   id: uuid (not null, default: gen_random_uuid())
//   tenant_id: uuid (not null)
//   student_name: text (not null)
//   status: text (not null, default: 'Ativo'::text)
//   demands: text (nullable)
//   barriers: text (nullable)
//   potentialities: text (nullable)
//   support_strategies: text (nullable)
//   accessibility_resources: text (nullable)
//   created_at: timestamp with time zone (not null, default: now())
//   updated_at: timestamp with time zone (not null, default: now())
...
//   status: text (not null, default: 'Em Elaboração'::text)
//   objectives: text (nullable)
//   strategies: text (nullable)
//   supports: text (nullable)
//   responsibles: text (nullable)
//   version: integer (nullable, default: 1)
//   created_at: timestamp with time zone (not null, default: now())
//   updated_at: timestamp with time zone (not null, default: now())
// Table: osc_inclusive_schools
//   id: uuid (not null, default: gen_random_uuid())
//   tenant_id: uuid (not null)
//   name: text (not null)
//   internal_code: text (nullable)
//   school_network: text (nullable)
//   city: text (nullable)
//   address: text (nullable)
//   school_type: text (nullable)
//   local_manager: text (nullable)
...
//   class_grade: text (nullable)
//   legal_guardians: text (nullable)
...
//   report_type: text (not null, default: 'Final'::text)
//   status: text (not null, default: 'Em Elaboração'::text)
//   deadline: date (nullable)
//   submission_date: date (nullable)
//   diligence_notes: text (nullable)
//   final_decision: text (nullable)
//   created_at: timestamp with time zone (not null, default: now())
//   updated_at: timestamp with time zone (not null, default: now())
// Table: osc_partnership_calls
//   id: uuid (not null, default: gen_random_uuid())
//   partnership_id: uuid (not null)
//   notice_number: text (nullable)
...
//   created_at: timestamp with time zone (not null, default: now())
//   updated_at: timestamp with time zone (not null, default: now())
// Table: osc_partnership_execution
//   id: uuid (not null, default: gen_random_uuid())
//   partnership_id: uuid (not null)
//   physical_progress: numeric (nullable, default: 0)
//   financial_progress: numeric (nullable, default: 0)
//   last_update: timestamp with time zone (not null, default: now())
//   created_at: timestamp with time zone (not null, default: now())
//   updated_at: timestamp with time zone (not null, default: now())
// Table: osc_partnership_goals
//   id: uuid (not null, default: gen_random_uuid())
//   workplan_id: uuid (not null)
//   title: text (not null)
//   description: text (nullable)
//   target_value: numeric (nullable, default: 0)
//   achieved_value: numeric (nullable, default: 0)
//   unit: text (nullable)
//   verification_method: text (nullable)
//   created_at: timestamp with time zone (not null, default: now())
//   updated_at: timestamp with time zone (not null, default: now())
// Table: osc_partnership_milestones
//   id: uuid (not null, default: gen_random_uuid())
//   partnership_id: uuid (not null)
//   title: text (not null)
//   description: text (nullable)
...
//   status: text (nullable, default: 'Pendente'::text)
//   created_at: timestamp with time zone (not null, default: now())
// Table: osc_partnership_workplans
//   id: uuid (not null, default: gen_random_uuid())
//   partnership_id: uuid (not null)
//   version: integer (nullable, default: 1)
//   status: text (nullable, default: 'Em Elaboração'::text)
//   methodology: text (nullable)
//   expected_results: text (nullable)
//   created_at: timestamp with time zone (not null, default: now())
//   updated_at: timestamp with time zone (not null, default: now())
// Table: osc_partnerships
//   id: uuid (not null, default: gen_random_uuid())
//   tenant_id: uuid (not null)
//   title: text (not null)
...
//   object_description: text (nullable)
//   current_phase: text (nullable, default: 'Planejamento'::text)
//   general_status: text (nullable, default: 'Regular'::text)
// Table: privacy_health_reports
//   id: uuid (not null, default: gen_random_uuid())
//   tenant_id: uuid (not null)
...
//   org_type: text (nullable, default: 'empresa'::text)
//   org_subtype: text (nullable)
//   labor_profile: jsonb (nullable, default: '{}'::jsonb)
//   digital_profile: jsonb (nullable, default: '{}'::jsonb)
//   public_relations: text (nullable, default: 'nao'::text)
//   acting_areas: jsonb (nullable, default: '[]'::jsonb)
// Table: user_tenants
...
// Table: digital_incidents
//   PRIMARY KEY digital_incidents_pkey: PRIMARY KEY (id)
//   FOREIGN KEY digital_incidents_tenant_id_fkey: FOREIGN KEY (tenant_id) REFERENCES tenants(id) ON DELETE CASCADE
// Table: digital_requests
//   PRIMARY KEY digital_requests_pkey: PRIMARY KEY (id)
//   FOREIGN KEY digital_requests_tenant_id_fkey: FOREIGN KEY (tenant_id) REFERENCES tenants(id) ON DELETE CASCADE
// Table: digital_ropa
//   PRIMARY KEY digital_ropa_pkey: PRIMARY KEY (id)
//   FOREIGN KEY digital_ropa_tenant_id_fkey: FOREIGN KEY (tenant_id) REFERENCES tenants(id) ON DELETE CASCADE
// Table: document_templates
...
// Table: osc_accountability_diligences
//   FOREIGN KEY osc_accountability_diligences_partnership_id_fkey: FOREIGN KEY (partnership_id) REFERENCES osc_partnerships(id) ON DELETE CASCADE
//   PRIMARY KEY osc_accountability_diligences_pkey: PRIMARY KEY (id)
// Table: osc_bank_accounts
//   FOREIGN KEY osc_bank_accounts_partnership_id_fkey: FOREIGN KEY (partnership_id) REFERENCES osc_partnerships(id) ON DELETE CASCADE
//   PRIMARY KEY osc_bank_accounts_pkey: PRIMARY KEY (id)
// Table: osc_bank_statement_lines
//   FOREIGN KEY osc_bank_statement_lines_account_id_fkey: FOREIGN KEY (account_id) REFERENCES osc_bank_accounts(id) ON DELETE SET NULL
//   FOREIGN KEY osc_bank_statement_lines_partnership_id_fkey: FOREIGN KEY (partnership_id) REFERENCES osc_partnerships(id) ON DELETE CASCADE
//   PRIMARY KEY osc_bank_statement_lines_pkey: PRIMARY KEY (id)
//   FOREIGN KEY osc_bank_statement_lines_restitution_line_id_fkey: FOREIGN KEY (restitution_line_id) REFERENCES osc_bank_statement_lines(id) ON DELETE SET NULL
// Table: osc_financial_incomes
//   FOREIGN KEY osc_financial_incomes_partnership_id_fkey: FOREIGN KEY (partnership_id) REFERENCES osc_partnerships(id) ON DELETE CASCADE
//   PRIMARY KEY osc_financial_incomes_pkey: PRIMARY KEY (id)
// Table: osc_financial_transactions
//   FOREIGN KEY osc_financial_transactions_partnership_id_fkey: FOREIGN KEY (partnership_id) REFERENCES osc_partnerships(id) ON DELETE CASCADE
//   PRIMARY KEY osc_financial_transactions_pkey: PRIMARY KEY (id)
// Table: osc_inclusive_cases
//   PRIMARY KEY osc_inclusive_cases_pkey: PRIMARY KEY (id)
...
//   FOREIGN KEY osc_inclusive_plans_tenant_id_fkey: FOREIGN KEY (tenant_id) REFERENCES tenants(id) ON DELETE CASCADE
// Table: osc_inclusive_schools
//   PRIMARY KEY osc_inclusive_schools_pkey: PRIMARY KEY (id)
//   FOREIGN KEY osc_inclusive_schools_tenant_id_fkey: FOREIGN KEY (tenant_id) REFERENCES tenants(id) ON DELETE CASCADE
// Table: osc_inclusive_students
...
// Table: osc_partnership_calls
//   FOREIGN KEY osc_partnership_calls_partnership_id_fkey: FOREIGN KEY (partnership_id) REFERENCES osc_partnerships(id) ON DELETE CASCADE
//   PRIMARY KEY osc_partnership_calls_pkey: PRIMARY KEY (id)
// Table: osc_partnership_execution
//   FOREIGN KEY osc_partnership_execution_partnership_id_fkey: FOREIGN KEY (partnership_id) REFERENCES osc_partnerships(id) ON DELETE CASCADE
//   PRIMARY KEY osc_partnership_execution_pkey: PRIMARY KEY (id)
// Table: osc_partnership_goals
//   PRIMARY KEY osc_partnership_goals_pkey: PRIMARY KEY (id)
//   FOREIGN KEY osc_partnership_goals_workplan_id_fkey: FOREIGN KEY (workplan_id) REFERENCES osc_partnership_workplans(id) ON DELETE CASCADE
// Table: osc_partnership_milestones
//   FOREIGN KEY osc_partnership_milestones_partnership_id_fkey: FOREIGN KEY (partnership_id) REFERENCES osc_partnerships(id) ON DELETE CASCADE
//   PRIMARY KEY osc_partnership_milestones_pkey: PRIMARY KEY (id)
// Table: osc_partnership_workplans
//   FOREIGN KEY osc_partnership_workplans_partnership_id_fkey: FOREIGN KEY (partnership_id) REFERENCES osc_partnerships(id) ON DELETE CASCADE
//   PRIMARY KEY osc_partnership_workplans_pkey: PRIMARY KEY (id)
// Table: osc_partnerships
//   PRIMARY KEY osc_partnerships_pkey: PRIMARY KEY (id)
//   FOREIGN KEY osc_partnerships_tenant_id_fkey: FOREIGN KEY (tenant_id) REFERENCES tenants(id) ON DELETE CASCADE
// Table: privacy_health_reports
//   PRIMARY KEY privacy_health_reports_pkey: PRIMARY KEY (id)
//   FOREIGN KEY privacy_health_reports_tenant_id_fkey: FOREIGN KEY (tenant_id) REFERENCES tenants(id) ON DELETE CASCADE
// Table: profile_reports
...
// Table: system_errors
//   PRIMARY KEY system_errors_pkey: PRIMARY KEY (id)
//   FOREIGN KEY system_errors_tenant_id_fkey: FOREIGN KEY (tenant_id) REFERENCES tenants(id) ON DELETE CASCADE
//   FOREIGN KEY system_errors_user_id_fkey: FOREIGN KEY (user_id) REFERENCES auth.users(id) ON DELETE SET NULL
// Table: tenants
...
//     USING: (((auth.jwt() ->> 'email'::text) = ANY (ARRAY['admin@example.com'::text, 'marcusthiago.adv@gmail.com'::text])) OR (((auth.jwt() -> 'app_metadata'::text) ->> 'role'::text) = 'admin'::text) OR (((auth.jwt() -> 'user_metadata'::text) ->> 'is_admin'::text) = 'true'::text) OR ((tenant_id IS NOT NULL) AND is_tenant_member_uuid(tenant_id)))
// Table: assessment_schedules
...
//     WITH CHECK: ((tenant_id IS NULL) OR is_tenant_member_uuid(tenant_id))
//   Policy "auth_read_logs" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: ((tenant_id IS NULL) OR is_tenant_member_uuid(tenant_id))
//   Policy "auth_update_logs" (UPDATE, PERMISSIVE) roles={authenticated}
//     USING: ((tenant_id IS NULL) OR is_tenant_member_uuid(tenant_id))
// Table: compliance_documents
...
//     USING: (EXISTS ( SELECT 1    FROM due_diligence_processes ddp   WHERE ((ddp.id = dd_red_flags.process_id) AND is_tenant_member_uuid(ddp.tenant_id))))
// Table: digital_incidents
//   Policy "auth_incidents_all" (ALL, PERMISSIVE) roles={authenticated}
//     USING: is_tenant_member_uuid(tenant_id)
//     WITH CHECK: is_tenant_member_uuid(tenant_id)
// Table: digital_requests
//   Policy "auth_requests_all" (ALL, PERMISSIVE) roles={authenticated}
//     USING: is_tenant_member_uuid(tenant_id)
//     WITH CHECK: is_tenant_member_uuid(tenant_id)
// Table: digital_ropa
//   Policy "auth_ropa_all" (ALL, PERMISSIVE) roles={authenticated}
//     USING: is_tenant_member_uuid(tenant_id)
//     WITH CHECK: is_tenant_member_uuid(tenant_id)
// Table: document_templates
...
//     WITH CHECK: true
// Table: osc_accountability_diligences
//   Policy "auth_all_osc_acc_dil" (ALL, PERMISSIVE) roles={authenticated}
//     USING: (EXISTS ( SELECT 1    FROM osc_partnerships p   WHERE ((p.id = osc_accountability_diligences.partnership_id) AND is_tenant_member_uuid(p.tenant_id))))
//     WITH CHECK: (EXISTS ( SELECT 1    FROM osc_partnerships p   WHERE ((p.id = osc_accountability_diligences.partnership_id) AND is_tenant_member_uuid(p.tenant_id))))
// Table: osc_bank_accounts
//   Policy "auth_all_osc_bank_accounts" (ALL, PERMISSIVE) roles={authenticated}
//     USING: (EXISTS ( SELECT 1    FROM osc_partnerships p   WHERE ((p.id = osc_bank_accounts.partnership_id) AND is_tenant_member_uuid(p.tenant_id))))
//     WITH CHECK: (EXISTS ( SELECT 1    FROM osc_partnerships p   WHERE ((p.id = osc_bank_accounts.partnership_id) AND is_tenant_member_uuid(p.tenant_id))))
// Table: osc_bank_statement_lines
//   Policy "auth_all_osc_bank_statement_lines" (ALL, PERMISSIVE) roles={authenticated}
//     USING: (EXISTS ( SELECT 1    FROM osc_partnerships p   WHERE ((p.id = osc_bank_statement_lines.partnership_id) AND is_tenant_member_uuid(p.tenant_id))))
//     WITH CHECK: (EXISTS ( SELECT 1    FROM osc_partnerships p   WHERE ((p.id = osc_bank_statement_lines.partnership_id) AND is_tenant_member_uuid(p.tenant_id))))
// Table: osc_financial_incomes
//   Policy "auth_all_osc_fin_inc" (ALL, PERMISSIVE) roles={authenticated}
//     USING: (EXISTS ( SELECT 1    FROM osc_partnerships p   WHERE ((p.id = osc_financial_incomes.partnership_id) AND is_tenant_member_uuid(p.tenant_id))))
//     WITH CHECK: (EXISTS ( SELECT 1    FROM osc_partnerships p   WHERE ((p.id = osc_financial_incomes.partnership_id) AND is_tenant_member_uuid(p.tenant_id))))
// Table: osc_financial_transactions
//   Policy "auth_all_osc_fin_trans" (ALL, PERMISSIVE) roles={authenticated}
//     USING: (EXISTS ( SELECT 1    FROM osc_partnerships p   WHERE ((p.id = osc_financial_transactions.partnership_id) AND is_tenant_member_uuid(p.tenant_id))))
//     WITH CHECK: (EXISTS ( SELECT 1    FROM osc_partnerships p   WHERE ((p.id = osc_financial_transactions.partnership_id) AND is_tenant_member_uuid(p.tenant_id))))
// Table: osc_inclusive_cases
...
//     WITH CHECK: is_tenant_member_uuid(tenant_id)
// Table: osc_inclusive_schools
//   Policy "auth_all_osc_inc_schools" (ALL, PERMISSIVE) roles={authenticated}
//     USING: is_tenant_member_uuid(tenant_id)
// Table: osc_inclusive_students
...
//     WITH CHECK: (EXISTS ( SELECT 1    FROM osc_partnerships p   WHERE ((p.id = osc_partnership_accountability.partnership_id) AND is_tenant_member_uuid(p.tenant_id))))
// Table: osc_partnership_calls
//   Policy "auth_all_osc_calls" (ALL, PERMISSIVE) roles={authenticated}
//     USING: (EXISTS ( SELECT 1    FROM osc_partnerships p   WHERE ((p.id = osc_partnership_calls.partnership_id) AND is_tenant_member_uuid(p.tenant_id))))
//     WITH CHECK: (EXISTS ( SELECT 1    FROM osc_partnerships p   WHERE ((p.id = osc_partnership_calls.partnership_id) AND is_tenant_member_uuid(p.tenant_id))))
// Table: osc_partnership_execution
//   Policy "auth_all_osc_exec" (ALL, PERMISSIVE) roles={authenticated}
//     USING: (EXISTS ( SELECT 1    FROM osc_partnerships p   WHERE ((p.id = osc_partnership_execution.partnership_id) AND is_tenant_member_uuid(p.tenant_id))))
//     WITH CHECK: (EXISTS ( SELECT 1    FROM osc_partnerships p   WHERE ((p.id = osc_partnership_execution.partnership_id) AND is_tenant_member_uuid(p.tenant_id))))
// Table: osc_partnership_goals
//   Policy "auth_all_goals" (ALL, PERMISSIVE) roles={authenticated}
//     USING: (EXISTS ( SELECT 1    FROM (osc_partnership_workplans w      JOIN osc_partnerships p ON ((p.id = w.partnership_id)))   WHERE ((w.id = osc_partnership_goals.workplan_id) AND is_tenant_member_uuid(p.tenant_id))))
// Table: osc_partnership_milestones
//   Policy "auth_all_milestones" (ALL, PERMISSIVE) roles={authenticated}
//     USING: (EXISTS ( SELECT 1    FROM osc_partnerships p   WHERE ((p.id = osc_partnership_milestones.partnership_id) AND is_tenant_member_uuid(p.tenant_id))))
// Table: osc_partnership_workplans
//   Policy "auth_all_workplans" (ALL, PERMISSIVE) roles={authenticated}
//     USING: (EXISTS ( SELECT 1    FROM osc_partnerships p   WHERE ((p.id = osc_partnership_workplans.partnership_id) AND is_tenant_member_uuid(p.tenant_id))))
// Table: osc_partnerships
//   Policy "auth_all_osc_partnerships" (ALL, PERMISSIVE) roles={authenticated}
//     USING: is_tenant_member_uuid(tenant_id)
//     WITH CHECK: is_tenant_member_uuid(tenant_id)
// Table: privacy_health_reports
//   Policy "auth_health_reports" (ALL, PERMISSIVE) roles={authenticated}
//     USING: is_tenant_member_uuid(tenant_id)
//     WITH CHECK: is_tenant_member_uuid(tenant_id)
// Table: profile_reports
//   Policy "auth_insert_reports_prof" (INSERT, PERMISSIVE) roles={authenticated}
//     WITH CHECK: ((tenant_id IS NULL) OR is_tenant_member_uuid(tenant_id))
...
//     WITH CHECK: is_tenant_member(tenant_id)
// Table: system_errors
//   Policy "anon_insert_errors" (INSERT, PERMISSIVE) roles={anon}
//     WITH CHECK: true
//   Policy "auth_insert_errors" (INSERT, PERMISSIVE) roles={authenticated}
//     WITH CHECK: true
//   Policy "auth_select_errors" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: (((auth.jwt() ->> 'email'::text) = ANY (ARRAY['admin@example.com'::text, 'marcusthiago.adv@gmail.com'::text])) OR (((auth.jwt() -> 'app_metadata'::text) ->> 'role'::text) = 'admin'::text) OR (((auth.jwt() -> 'user_metadata'::text) ->> 'is_admin'::text) = 'true'::text))
// Table: tenants
...
//   $function$
//
// FUNCTION check_suspicious_audit_log()
...
// --- TRIGGERS ---
// Table: audit_logs
//   trg_check_suspicious_audit_log: CREATE TRIGGER trg_check_suspicious_audit_log AFTER INSERT ON public.audit_logs FOR EACH ROW EXECUTE FUNCTION check_suspicious_audit_log()
// Table: tenants
